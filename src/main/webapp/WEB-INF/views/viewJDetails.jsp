								...
								<div class="panel-body">
									...
									<div>
										...
										<!--<form id="statusForm" class="form-profile" commandName="jobApplied" action="submitStatus.htm">-->
											...
											<form class="form-profile" action="${pageContext.request.contextPath}/applyDetailedJob/${details.jobId }.htm" method="post">
												
												<a href="${pageContext.request.contextPath}/getJobRecords.htm?pageNumber=0" class="btn btn-default">Back</a>
